        ...
        <div class="col-12">
          <div class="card">
            <div class="card-header">
              <h1 class="card-title">Table Anggota</h1>
            ...
            <!-- /.card-header -->
            <div class="card-body">
              <table id="tab_anggota" class="table table-bordered" style="width:100%">
                  <thead>
                     <tr>
                        <th>No Anggota</th>
                        <th>Nama Anggota</th>
      ...
      <script type="text/javascript">
         $(document).ready(function() {
          ...
          $(document).on('hide.bs.modal','#Modal', function() {
            $('#tab_anggota').DataTable().ajax.reload();
          });
          ...
          $(document).on('click', '.delete', function(){
            var bebas = $(this).attr('id');
              if (confirm("Yakin Dihapus ?")) {
                ...
                $.ajax({
                  url: "{{route('ajaxdata.removedataanggota')}}",
                  method: "get",
                  data:{id:bebas},
                  success: function(data){
                    swal({
